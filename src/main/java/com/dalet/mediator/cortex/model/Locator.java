...
public class Locator {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Locator
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Locator.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
