...
public class Locator {
   ...
   * @return awsS3Bucket
  **/
  @ApiModelProperty(example = "dalet-AI-bucket", required = true, value = "Name of an AWS S3 bucket")
   ...
   * @return awsS3Key
  **/
  @ApiModelProperty(example = "0000132.mp4", required = true, value = "Name of a file in the AWS S3 bucket. For example, name of media file to be indexed in an Input Locator or name of a JSON file in an Output Locator.")
