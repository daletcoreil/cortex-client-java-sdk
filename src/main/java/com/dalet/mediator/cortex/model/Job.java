...
public class Job {
  ...
  public enum JobProfileEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      JobProfileEnum.fromValue(value);
    }
  }
  ...
  @javax.annotation.Nullable
  private Integer maxRegionLatency = 100;
  ...
  public Job jobType(@javax.annotation.Nullable JobTypeEnum jobType) {
  ...
  public void setJobType(@javax.annotation.Nullable JobTypeEnum jobType) {
    this.jobType = jobType;
  }


  public Job jobProfile(@javax.annotation.Nullable JobProfileEnum jobProfile) {
  ...
  public void setJobProfile(@javax.annotation.Nullable JobProfileEnum jobProfile) {
    this.jobProfile = jobProfile;
  }


  public Job regionName(@javax.annotation.Nullable String regionName) {
  ...
  public Job maxRegionLatency(@javax.annotation.Nullable Integer maxRegionLatency) {
   ...
   */
  @javax.annotation.Nullable
  public Integer getMaxRegionLatency() {
    return maxRegionLatency;
  }

  public void setMaxRegionLatency(@javax.annotation.Nullable Integer maxRegionLatency) {
    this.maxRegionLatency = maxRegionLatency;
  }


  public Job jobInput(@javax.annotation.Nullable JobInput jobInput) {
  ...
  public void setJobInput(@javax.annotation.Nullable JobInput jobInput) {
    this.jobInput = jobInput;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(jobType, jobProfile, regionName, maxRegionLatency, jobInput, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("maxRegionLatency");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("jobProfile") != null && !jsonObj.get("jobProfile").isJsonNull()) && !jsonObj.get("jobProfile").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `jobProfile` to be a primitive type in the JSON string but got `%s`", jsonObj.get("jobProfile").toString()));
      }
      // validate the optional field `jobProfile`
      if (jsonObj.get("jobProfile") != null && !jsonObj.get("jobProfile").isJsonNull()) {
        JobProfileEnum.validateJsonElement(jsonObj.get("jobProfile"));
      }
      ...
      if (jsonObj.get("jobInput") != null && !jsonObj.get("jobInput").isJsonNull()) {
        JobInput.validateJsonElement(jsonObj.get("jobInput"));
      }
  }
