...
public class JobType {
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
