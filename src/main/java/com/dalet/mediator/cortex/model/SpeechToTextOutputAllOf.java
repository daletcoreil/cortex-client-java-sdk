...
public class SpeechToTextOutputAllOf {
  ...
  public SpeechToTextOutputAllOf() {
  }

  public SpeechToTextOutputAllOf jsonFormat(Locator jsonFormat) {
  ...
  **/
  ...
  public SpeechToTextOutputAllOf ttmlFormat(Locator ttmlFormat) {
  ...
  **/
  ...
  public SpeechToTextOutputAllOf srtFormat(Locator srtFormat) {
  ...
  **/
  ...
  public SpeechToTextOutputAllOf textFormat(Locator textFormat) {
  ...
  **/
  ...
  public SpeechToTextOutputAllOf draftjsFormat(Locator draftjsFormat) {
  ...
  **/
   ...
   * @return the SpeechToTextOutputAllOf instance itself
   */
  public SpeechToTextOutputAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SpeechToTextOutputAllOf speechToTextOutputAllOf = (SpeechToTextOutputAllOf) o;
    return Objects.equals(this.jsonFormat, speechToTextOutputAllOf.jsonFormat) &&
        Objects.equals(this.ttmlFormat, speechToTextOutputAllOf.ttmlFormat) &&
        Objects.equals(this.srtFormat, speechToTextOutputAllOf.srtFormat) &&
        Objects.equals(this.textFormat, speechToTextOutputAllOf.textFormat) &&
        Objects.equals(this.draftjsFormat, speechToTextOutputAllOf.draftjsFormat)&&
        Objects.equals(this.additionalProperties, speechToTextOutputAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jsonFormat, ttmlFormat, srtFormat, textFormat, draftjsFormat, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SpeechToTextOutputAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SpeechToTextOutputAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SpeechToTextOutputAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpeechToTextOutputAllOf is not found in the empty JSON string", SpeechToTextOutputAllOf.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `jsonFormat`
      if (jsonObj.get("jsonFormat") != null && !jsonObj.get("jsonFormat").isJsonNull()) {
        Locator.validateJsonObject(jsonObj.getAsJsonObject("jsonFormat"));
      }
      // validate the optional field `ttmlFormat`
      if (jsonObj.get("ttmlFormat") != null && !jsonObj.get("ttmlFormat").isJsonNull()) {
        Locator.validateJsonObject(jsonObj.getAsJsonObject("ttmlFormat"));
      }
      // validate the optional field `srtFormat`
      if (jsonObj.get("srtFormat") != null && !jsonObj.get("srtFormat").isJsonNull()) {
        Locator.validateJsonObject(jsonObj.getAsJsonObject("srtFormat"));
      }
      // validate the optional field `textFormat`
      if (jsonObj.get("textFormat") != null && !jsonObj.get("textFormat").isJsonNull()) {
        Locator.validateJsonObject(jsonObj.getAsJsonObject("textFormat"));
      }
      // validate the optional field `draftjsFormat`
      if (jsonObj.get("draftjsFormat") != null && !jsonObj.get("draftjsFormat").isJsonNull()) {
        Locator.validateJsonObject(jsonObj.getAsJsonObject("draftjsFormat"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpeechToTextOutputAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpeechToTextOutputAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpeechToTextOutputAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpeechToTextOutputAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SpeechToTextOutputAllOf>() {
           @Override
           public void write(JsonWriter out, SpeechToTextOutputAllOf value) throws IOException {
           ...
           @Override
           public SpeechToTextOutputAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SpeechToTextOutputAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SpeechToTextOutputAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SpeechToTextOutputAllOf
  * @throws IOException if the JSON string is invalid with respect to SpeechToTextOutputAllOf
  */
  public static SpeechToTextOutputAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpeechToTextOutputAllOf.class);
  }

 /**
  * Convert an instance of SpeechToTextOutputAllOf to an JSON string
  *
  * @return JSON string
  */
