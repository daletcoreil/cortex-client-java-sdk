...
public class VideoAnalysisOutputAllOf {
  public static final String SERIALIZED_NAME_OUTPUT_FILE = "outputFile";
  @SerializedName(SERIALIZED_NAME_OUTPUT_FILE)
  private Locator outputFile;

  public VideoAnalysisOutputAllOf() {
  }

  public VideoAnalysisOutputAllOf outputFile(Locator outputFile) {
  ...
  **/
  ...
  public Locator getOutputFile() {
    return outputFile;
  }


  public void setOutputFile(Locator outputFile) {
    this.outputFile = outputFile;
  }
   ...
   * @return the VideoAnalysisOutputAllOf instance itself
   */
  public VideoAnalysisOutputAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VideoAnalysisOutputAllOf videoAnalysisOutputAllOf = (VideoAnalysisOutputAllOf) o;
    return Objects.equals(this.outputFile, videoAnalysisOutputAllOf.outputFile)&&
        Objects.equals(this.additionalProperties, videoAnalysisOutputAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(outputFile, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VideoAnalysisOutputAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VideoAnalysisOutputAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VideoAnalysisOutputAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoAnalysisOutputAllOf is not found in the empty JSON string", VideoAnalysisOutputAllOf.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `outputFile`
      if (jsonObj.get("outputFile") != null && !jsonObj.get("outputFile").isJsonNull()) {
        Locator.validateJsonObject(jsonObj.getAsJsonObject("outputFile"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoAnalysisOutputAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoAnalysisOutputAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoAnalysisOutputAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoAnalysisOutputAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoAnalysisOutputAllOf>() {
           @Override
           public void write(JsonWriter out, VideoAnalysisOutputAllOf value) throws IOException {
           ...
           @Override
           public VideoAnalysisOutputAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VideoAnalysisOutputAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VideoAnalysisOutputAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VideoAnalysisOutputAllOf
  * @throws IOException if the JSON string is invalid with respect to VideoAnalysisOutputAllOf
  */
  public static VideoAnalysisOutputAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoAnalysisOutputAllOf.class);
  }

 /**
  * Convert an instance of VideoAnalysisOutputAllOf to an JSON string
  *
  * @return JSON string
  */
