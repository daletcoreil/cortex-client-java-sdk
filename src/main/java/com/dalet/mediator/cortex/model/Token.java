...
public class Token {
  ...
  public Token authorization(@javax.annotation.Nonnull String authorization) {
  ...
  public Token expires(@javax.annotation.Nonnull Integer expires) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorization, expires, additionalProperties);
  }
