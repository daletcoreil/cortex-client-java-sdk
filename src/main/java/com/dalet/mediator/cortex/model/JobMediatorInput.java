...
public class JobMediatorInput {
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobMediatorInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobMediatorInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
