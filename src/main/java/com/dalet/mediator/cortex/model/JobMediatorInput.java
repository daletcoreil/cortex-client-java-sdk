...
import com.dalet.mediator.cortex.model.Job;
...
public class JobMediatorInput {
  ...
  public JobMediatorInput() {
  }

  public JobMediatorInput projectServiceId(@javax.annotation.Nonnull String projectServiceId) {
  ...
  public void setProjectServiceId(@javax.annotation.Nonnull String projectServiceId) {
    this.projectServiceId = projectServiceId;
  }


  public JobMediatorInput quantity(@javax.annotation.Nonnull Integer quantity) {
  ...
  public JobMediatorInput tracking(@javax.annotation.Nullable Object tracking) {
  ...
  public void setTracking(@javax.annotation.Nullable Object tracking) {
    this.tracking = tracking;
  }


  public JobMediatorInput notificationEndpoint(@javax.annotation.Nullable String notificationEndpoint) {
  ...
  public void setNotificationEndpoint(@javax.annotation.Nullable String notificationEndpoint) {
    this.notificationEndpoint = notificationEndpoint;
  }


  public JobMediatorInput job(@javax.annotation.Nonnull Job job) {
    this.job = job;
    return this;
  }
   ...
   * @return the JobMediatorInput instance itself
   */
  public JobMediatorInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.projectServiceId, jobMediatorInput.projectServiceId) &&
        ...
        Objects.equals(this.additionalProperties, jobMediatorInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectServiceId, quantity, tracking, notificationEndpoint, job, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("projectServiceId");
    ...
    openapiRequiredFields.add("projectServiceId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobMediatorInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobMediatorInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobMediatorInput is not found in the empty JSON string", JobMediatorInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JobMediatorInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("projectServiceId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `projectServiceId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("projectServiceId").toString()));
      }
      if ((jsonObj.get("notificationEndpoint") != null && !jsonObj.get("notificationEndpoint").isJsonNull()) && !jsonObj.get("notificationEndpoint").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobMediatorInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobMediatorInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobMediatorInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobMediatorInput.class));

       return (TypeAdapter<T>) new TypeAdapter<JobMediatorInput>() {
           @Override
           public void write(JsonWriter out, JobMediatorInput value) throws IOException {
           ...
           @Override
           public JobMediatorInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             JobMediatorInput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of JobMediatorInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobMediatorInput
   * @throws IOException if the JSON string is invalid with respect to JobMediatorInput
   */
  public static JobMediatorInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobMediatorInput.class);
  }

  /**
   * Convert an instance of JobMediatorInput to an JSON string
   *
   * @return JSON string
   */
