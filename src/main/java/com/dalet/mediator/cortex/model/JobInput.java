...
public class JobInput {
  ...
  public JobInput jobInputType(String jobInputType) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      String discriminatorValue = jsonObj.get("jobInputType").getAsString();
      switch (discriminatorValue) {
        case "SpeechToTextInput":
          SpeechToTextInput.validateJsonObject(jsonObj);
          break;
        case "VideoAnalysisInput":
          VideoAnalysisInput.validateJsonObject(jsonObj);
          break;
        default: 
