...
public class SpeechToTextInput extends JobInput {
  ...
  **/
  ...
  public SpeechToTextInput startOfMaterial(java.lang.Double startOfMaterial) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(inputFile, outputLocation, title, language, startOfMaterial, vocabulary, super.hashCode(), additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SpeechToTextInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SpeechToTextInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
