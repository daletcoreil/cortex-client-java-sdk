...
public class SpeechToTextOutput extends JobOutput {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SpeechToTextOutput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SpeechToTextOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
