...
public class JobMediatorStatus {
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobMediatorStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobMediatorStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
