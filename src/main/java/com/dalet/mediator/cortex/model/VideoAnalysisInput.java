...
public class VideoAnalysisInput extends JobInput {
  ...
  public enum DataFilterEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      DataFilterEnum.fromValue(value);
    }
  }
  ...
  private List<DataFilterEnum> dataFilter = new ArrayList<>();
  ...
  public VideoAnalysisInput() {
    this.jobInputType = this.getClass().getSimpleName();
  }

  public VideoAnalysisInput inputFile(@javax.annotation.Nonnull Locator inputFile) {
  ...
  public VideoAnalysisInput outputLocation(@javax.annotation.Nonnull Locator outputLocation) {
  ...
  public void setOutputLocation(@javax.annotation.Nonnull Locator outputLocation) {
    this.outputLocation = outputLocation;
  }


  public VideoAnalysisInput dataFilter(@javax.annotation.Nullable List<DataFilterEnum> dataFilter) {
  ...
  public void setDataFilter(@javax.annotation.Nullable List<DataFilterEnum> dataFilter) {
    this.dataFilter = dataFilter;
  }


  public VideoAnalysisInput language(@javax.annotation.Nullable String language) {
  ...
  public VideoAnalysisInput startOfMaterial(@javax.annotation.Nullable java.lang.Double startOfMaterial) {
   ...
   * @return the VideoAnalysisInput instance itself
   */
  public VideoAnalysisInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inputFile, videoAnalysisInput.inputFile) &&
        ...
        Objects.equals(this.additionalProperties, videoAnalysisInput.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inputFile, outputLocation, dataFilter, language, startOfMaterial, super.hashCode(), additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoAnalysisInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoAnalysisInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoAnalysisInput is not found in the empty JSON string", VideoAnalysisInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VideoAnalysisInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoAnalysisInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoAnalysisInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoAnalysisInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoAnalysisInput.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoAnalysisInput>() {
           @Override
           public void write(JsonWriter out, VideoAnalysisInput value) throws IOException {
           ...
           @Override
           public VideoAnalysisInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             VideoAnalysisInput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of VideoAnalysisInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoAnalysisInput
   * @throws IOException if the JSON string is invalid with respect to VideoAnalysisInput
   */
  public static VideoAnalysisInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoAnalysisInput.class);
  }

  /**
   * Convert an instance of VideoAnalysisInput to an JSON string
   *
   * @return JSON string
   */
