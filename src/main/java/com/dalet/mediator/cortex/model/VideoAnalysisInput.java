...
public class VideoAnalysisInput extends JobInput {
  ...
  **/
  ...
  public VideoAnalysisInput startOfMaterial(java.lang.Double startOfMaterial) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to VideoAnalysisInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VideoAnalysisInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
