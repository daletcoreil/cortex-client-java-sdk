...
public class VideoAnalysisOutput extends JobOutput {
  ...
  public VideoAnalysisOutput() {
    this.jobOutputType = this.getClass().getSimpleName();
  }

  public VideoAnalysisOutput outputFile(@javax.annotation.Nullable Locator outputFile) {
  ...
  public void setOutputFile(@javax.annotation.Nullable Locator outputFile) {
    this.outputFile = outputFile;
  }
   ...
   * @return the VideoAnalysisOutput instance itself
   */
  public VideoAnalysisOutput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VideoAnalysisOutput videoAnalysisOutput = (VideoAnalysisOutput) o;
    return Objects.equals(this.outputFile, videoAnalysisOutput.outputFile)&&
        Objects.equals(this.additionalProperties, videoAnalysisOutput.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(outputFile, super.hashCode(), additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VideoAnalysisOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoAnalysisOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoAnalysisOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoAnalysisOutput is not found in the empty JSON string", VideoAnalysisOutput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VideoAnalysisOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoAnalysisOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoAnalysisOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoAnalysisOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoAnalysisOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoAnalysisOutput>() {
           @Override
           public void write(JsonWriter out, VideoAnalysisOutput value) throws IOException {
           ...
           @Override
           public VideoAnalysisOutput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             VideoAnalysisOutput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of VideoAnalysisOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoAnalysisOutput
   * @throws IOException if the JSON string is invalid with respect to VideoAnalysisOutput
   */
  public static VideoAnalysisOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoAnalysisOutput.class);
  }

  /**
   * Convert an instance of VideoAnalysisOutput to an JSON string
   *
   * @return JSON string
   */
