...
public class VideoAnalysisOutput extends JobOutput {
  ...
  public VideoAnalysisOutput outputFile(Locator outputFile) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to VideoAnalysisOutput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VideoAnalysisOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
