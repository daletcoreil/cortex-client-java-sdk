...
public class SpeechToTextVocabulary {
  public static final String SERIALIZED_NAME_CONTENT = "content";
  @SerializedName(SERIALIZED_NAME_CONTENT)
  @javax.annotation.Nullable
  private String content;

  public static final String SERIALIZED_NAME_SOUNDS_LIKE = "sounds_like";
  @SerializedName(SERIALIZED_NAME_SOUNDS_LIKE)
  @javax.annotation.Nullable
  private List<String> soundsLike = new ArrayList<>();

  public SpeechToTextVocabulary() {
  }

  public SpeechToTextVocabulary content(@javax.annotation.Nullable String content) {
  ...
  public SpeechToTextVocabulary soundsLike(@javax.annotation.Nullable List<String> soundsLike) {
    this.soundsLike = soundsLike;
    return this;
  }

  public SpeechToTextVocabulary addSoundsLikeItem(String soundsLikeItem) {
  ...
  public void setSoundsLike(@javax.annotation.Nullable List<String> soundsLike) {
    this.soundsLike = soundsLike;
  }
   ...
   * @return the SpeechToTextVocabulary instance itself
   */
  public SpeechToTextVocabulary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SpeechToTextVocabulary speechToTextVocabulary = (SpeechToTextVocabulary) o;
    return Objects.equals(this.content, speechToTextVocabulary.content) &&
        Objects.equals(this.soundsLike, speechToTextVocabulary.soundsLike)&&
        Objects.equals(this.additionalProperties, speechToTextVocabulary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, soundsLike, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SpeechToTextVocabulary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SpeechToTextVocabulary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpeechToTextVocabulary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpeechToTextVocabulary is not found in the empty JSON string", SpeechToTextVocabulary.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("sounds_like") != null && !jsonObj.get("sounds_like").isJsonNull() && !jsonObj.get("sounds_like").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `sounds_like` to be an array in the JSON string but got `%s`", jsonObj.get("sounds_like").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpeechToTextVocabulary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpeechToTextVocabulary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpeechToTextVocabulary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpeechToTextVocabulary.class));

       return (TypeAdapter<T>) new TypeAdapter<SpeechToTextVocabulary>() {
           @Override
           public void write(JsonWriter out, SpeechToTextVocabulary value) throws IOException {
           ...
           @Override
           public SpeechToTextVocabulary read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SpeechToTextVocabulary instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SpeechToTextVocabulary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SpeechToTextVocabulary
   * @throws IOException if the JSON string is invalid with respect to SpeechToTextVocabulary
   */
  public static SpeechToTextVocabulary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpeechToTextVocabulary.class);
  }

  /**
   * Convert an instance of SpeechToTextVocabulary to an JSON string
   *
   * @return JSON string
   */
