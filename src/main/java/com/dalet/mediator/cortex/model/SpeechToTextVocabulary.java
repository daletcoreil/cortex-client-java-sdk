...
public class SpeechToTextVocabulary {
  ...
  public SpeechToTextVocabulary content(String content) {
  ...
  **/
  ...
  public SpeechToTextVocabulary soundsLike(List<String> soundsLike) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SpeechToTextVocabulary
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SpeechToTextVocabulary.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("sounds_like") != null && !jsonObj.get("sounds_like").isJsonArray()) {
