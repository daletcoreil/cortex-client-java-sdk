...
public class VideoAnalysisInputAllOf {
  ...
  private List<DataFilterEnum> dataFilter;
  ...
  public VideoAnalysisInputAllOf() {
  }

  public VideoAnalysisInputAllOf inputFile(Locator inputFile) {
  ...
  **/
  ...
  public VideoAnalysisInputAllOf outputLocation(Locator outputLocation) {
  ...
  **/
  ...
  public VideoAnalysisInputAllOf dataFilter(List<DataFilterEnum> dataFilter) {
    
    this.dataFilter = dataFilter;
    return this;
  }

  public VideoAnalysisInputAllOf addDataFilterItem(DataFilterEnum dataFilterItem) {
  ...
  **/
  ...
  public VideoAnalysisInputAllOf language(String language) {
  ...
  **/
  ...
  public VideoAnalysisInputAllOf startOfMaterial(java.lang.Double startOfMaterial) {
  ...
  **/
   ...
   * @return the VideoAnalysisInputAllOf instance itself
   */
  public VideoAnalysisInputAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VideoAnalysisInputAllOf videoAnalysisInputAllOf = (VideoAnalysisInputAllOf) o;
    return Objects.equals(this.inputFile, videoAnalysisInputAllOf.inputFile) &&
        Objects.equals(this.outputLocation, videoAnalysisInputAllOf.outputLocation) &&
        Objects.equals(this.dataFilter, videoAnalysisInputAllOf.dataFilter) &&
        Objects.equals(this.language, videoAnalysisInputAllOf.language) &&
        Objects.equals(this.startOfMaterial, videoAnalysisInputAllOf.startOfMaterial)&&
        Objects.equals(this.additionalProperties, videoAnalysisInputAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inputFile, outputLocation, dataFilter, language, startOfMaterial, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VideoAnalysisInputAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VideoAnalysisInputAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VideoAnalysisInputAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoAnalysisInputAllOf is not found in the empty JSON string", VideoAnalysisInputAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VideoAnalysisInputAllOf.openapiRequiredFields) {
      ...
      Locator.validateJsonObject(jsonObj.getAsJsonObject("outputLocation"));
      // ensure the optional json data is an array if present
      if (jsonObj.get("dataFilter") != null && !jsonObj.get("dataFilter").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `dataFilter` to be an array in the JSON string but got `%s`", jsonObj.get("dataFilter").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoAnalysisInputAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoAnalysisInputAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoAnalysisInputAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoAnalysisInputAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoAnalysisInputAllOf>() {
           @Override
           public void write(JsonWriter out, VideoAnalysisInputAllOf value) throws IOException {
           ...
           @Override
           public VideoAnalysisInputAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VideoAnalysisInputAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VideoAnalysisInputAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VideoAnalysisInputAllOf
  * @throws IOException if the JSON string is invalid with respect to VideoAnalysisInputAllOf
  */
  public static VideoAnalysisInputAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoAnalysisInputAllOf.class);
  }

 /**
  * Convert an instance of VideoAnalysisInputAllOf to an JSON string
  *
  * @return JSON string
  */
