        ...
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                .registerTypeSelector(JobInput.class, new TypeSelector() {
                    ...
                    public Class getClassForElement(JsonElement readElement) {
                        ...
                        classByDiscriminatorValue.put("VideoAnalysisInput".toUpperCase(Locale.ROOT), VideoAnalysisInput.class);
                        classByDiscriminatorValue.put("SpeechToTextInput".toUpperCase(Locale.ROOT), SpeechToTextInput.class);
                        classByDiscriminatorValue.put("JobInput".toUpperCase(Locale.ROOT), JobInput.class);
                ...
                .registerTypeSelector(JobOutput.class, new TypeSelector() {
                    ...
                    public Class getClassForElement(JsonElement readElement) {
                        Map classByDiscriminatorValue = new HashMap();
                        classByDiscriminatorValue.put("VideoAnalysisOutput".toUpperCase(Locale.ROOT), VideoAnalysisOutput.class);
                        classByDiscriminatorValue.put("SpeechToTextOutput".toUpperCase(Locale.ROOT), SpeechToTextOutput.class);
                        classByDiscriminatorValue.put("JobOutput".toUpperCase(Locale.ROOT), JobOutput.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
