...
import com.dalet.mediator.cortex.model.JobType;
...
public class JobTypesApi {
    ...
    /**
     * Build call for getAllJobTypes
     * @param projectServiceId Project service id of the client which associated to the request (required)
     ...
     */
    public okhttp3.Call getAllJobTypesCall(String projectServiceId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllJobTypesValidateBeforeCall(String projectServiceId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projectServiceId' is set
        if (projectServiceId == null) {
            throw new ApiException("Missing the required parameter 'projectServiceId' when calling getAllJobTypes(Async)");
        }
        

        okhttp3.Call localVarCall = getAllJobTypesCall(projectServiceId, _callback);
        return localVarCall;
     ...
     */
    public List<JobType> getAllJobTypes(String projectServiceId) throws ApiException {
        ApiResponse<List<JobType>> localVarResp = getAllJobTypesWithHttpInfo(projectServiceId);
     ...
     */
    public ApiResponse<List<JobType>> getAllJobTypesWithHttpInfo(String projectServiceId) throws ApiException {
        okhttp3.Call localVarCall = getAllJobTypesValidateBeforeCall(projectServiceId, null);
     ...
     */
    public okhttp3.Call getAllJobTypesAsync(String projectServiceId, final ApiCallback<List<JobType>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllJobTypesValidateBeforeCall(projectServiceId, _callback);
        Type localVarReturnType = new TypeToken<List<JobType>>(){}.getType();
