...
import com.dalet.mediator.cortex.model.JobMediatorInput;
import com.dalet.mediator.cortex.model.MediatorJob;
...
public class JobsApiTest {
    ...
    public void createJobTest() throws ApiException {
        JobMediatorInput jobMediatorInput = null;
        MediatorJob response = api.createJob(jobMediatorInput);
    ...
    public void getJobByIdTest() throws ApiException {
        String jobId = null;
        MediatorJob response = api.getJobById(jobId);
