...
/**
 * API tests for JobTypesApi
 */
@Ignore
public class JobTypesApiTest {

    private final JobTypesApi api = new JobTypesApi();
     ...
     */
    @Test
    public void getAllJobTypesTest() throws ApiException {
        String projectServiceId = null;
        List<JobType> response = api.getAllJobTypes(projectServiceId);
