...
- API version: 2.0.0
  - Build date: 2023-06-27T06:13:14.477763Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.dalet.mediator:cortex-client:2.0.0"
  }
```
...
* `target/cortex-client-2.0.0.jar`
* `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [SpeechToTextInputAllOf](docs/SpeechToTextInputAllOf.md)
 - [SpeechToTextOutput](docs/SpeechToTextOutput.md)
 - [SpeechToTextOutputAllOf](docs/SpeechToTextOutputAllOf.md)
 - [SpeechToTextVocabulary](docs/SpeechToTextVocabulary.md)
 - [Token](docs/Token.md)
 - [VideoAnalysisInput](docs/VideoAnalysisInput.md)
 - [VideoAnalysisInputAllOf](docs/VideoAnalysisInputAllOf.md)
 - [VideoAnalysisOutput](docs/VideoAnalysisOutput.md)
 - [VideoAnalysisOutputAllOf](docs/VideoAnalysisOutputAllOf.md)
